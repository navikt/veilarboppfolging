...
ALTER TABLE OPPFOLGINGSTATUS MODIFY AKTOR_ID NVARCHAR2(255);
...
ALTER TABLE MANUELL_STATUS MODIFY AKTOR_ID NVARCHAR2(255);

ALTER TABLE MAL RENAME COLUMN AKTORID TO AKTOR_ID;
ALTER TABLE MAL MODIFY AKTOR_ID NVARCHAR2(255);

ALTER TABLE BRUKERVILKAR RENAME COLUMN AKTORID TO AKTOR_ID;
ALTER TABLE BRUKERVILKAR MODIFY AKTOR_ID NVARCHAR2(255);

ALTER TABLE OPPFOLGINGSPERIODE RENAME COLUMN AKTORID TO AKTOR_ID;
ALTER TABLE OPPFOLGINGSPERIODE MODIFY AKTOR_ID NVARCHAR2(255);
