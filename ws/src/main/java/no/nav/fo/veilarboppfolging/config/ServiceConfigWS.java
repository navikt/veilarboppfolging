...
public class ServiceConfigWS {
    ...
    @Bean
    ReserverKrrService reserverKrrService(DigitalKontaktinformasjonService digitalKontaktinformasjonService) {
        return new ReserverKrrService(digitalKontaktinformasjonService);
    }
}
