...
create table kandidater_for_utmelding (
    ...
    oppfolgingsperiode_uuid char(36) references oppfolgingsperiode(uuid) not null primary key,
...
create table filterkategori_id_mapping (
    ...
    oppfolgingsperiode_id char(36) references oppfolgingsperiode(uuid) not null,
