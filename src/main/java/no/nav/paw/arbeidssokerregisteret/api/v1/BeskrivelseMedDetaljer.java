...
public class BeskrivelseMedDetaljer extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private no.nav.paw.arbeidssokerregisteret.api.v1.Beskrivelse beskrivelse;
  /** * Feltene taes bare med dersom de er er tilgjengelige, i praksis må klienter støtte å motta en tom map.
	  ...
	  * gjelder_til_dato_iso8601	-		datoen jobbsituasjonen gjelder til (eksempel 2019-01-27)
  	  ...
  	  * siste_arbeidsdag_iso8601	-		Siste arbeidssdag. Ikke nødvendigvis siste dag det betales lønn for, feks ved konkurs(eksempel 2019-01-27).
  	  * */
  private java.util.Map<java.lang.CharSequence,java.lang.CharSequence> detaljer;
   ...
   * @param detaljer * Feltene taes bare med dersom de er er tilgjengelige, i praksis må klienter støtte å motta en tom map.
	  ...
	  * gjelder_til_dato_iso8601	-		datoen jobbsituasjonen gjelder til (eksempel 2019-01-27)
  	  ...
  	  *
   */
  public BeskrivelseMedDetaljer(no.nav.paw.arbeidssokerregisteret.api.v1.Beskrivelse beskrivelse, java.util.Map<java.lang.CharSequence,java.lang.CharSequence> detaljer) {
  ...
  public java.lang.Object get(int field$) {
    switch (field$) {
    case 0: return beskrivelse;
    case 1: return detaljer;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: beskrivelse = (no.nav.paw.arbeidssokerregisteret.api.v1.Beskrivelse)value$; break;
    case 1: detaljer = (java.util.Map<java.lang.CharSequence,java.lang.CharSequence>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public no.nav.paw.arbeidssokerregisteret.api.v1.Beskrivelse getBeskrivelse() {
    return beskrivelse;
  }
   ...
   */
  public void setBeskrivelse(no.nav.paw.arbeidssokerregisteret.api.v1.Beskrivelse value) {
   ...
   * @return * Feltene taes bare med dersom de er er tilgjengelige, i praksis må klienter støtte å motta en tom map.
	  ...
	  * gjelder_til_dato_iso8601	-		datoen jobbsituasjonen gjelder til (eksempel 2019-01-27)
  	  ...
  	  *
   */
  public java.util.Map<java.lang.CharSequence,java.lang.CharSequence> getDetaljer() {
    return detaljer;
  }
   ...
   * @param value the value to set.
   */
  public void setDetaljer(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    this.detaljer = value;
  }
   ...
   */
  public static no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer.Builder newBuilder() {
    return new no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer.Builder();
  }
   ...
   * @return A new BeskrivelseMedDetaljer RecordBuilder
   */
  public static no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer.Builder newBuilder(no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer.Builder other) {
    if (other == null) {
      return new no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer.Builder();
    } else {
      return new no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer.Builder(other);
    }
  }
   ...
   * @return A new BeskrivelseMedDetaljer RecordBuilder
   */
  public static no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer.Builder newBuilder(no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer other) {
    if (other == null) {
      return new no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer.Builder();
    } else {
      return new no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<BeskrivelseMedDetaljer>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.beskrivelse)) {
        this.beskrivelse = data().deepCopy(fields()[0].schema(), other.beskrivelse);
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer.Builder setBeskrivelse(no.nav.paw.arbeidssokerregisteret.api.v1.Beskrivelse value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer.Builder clearBeskrivelse() {
      beskrivelse = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer.Builder setDetaljer(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer.Builder clearDetaljer() {
      detaljer = null;
    ...
    public BeskrivelseMedDetaljer build() {
      try {
        ...
        record.beskrivelse = fieldSetFlags()[0] ? this.beskrivelse : (no.nav.paw.arbeidssokerregisteret.api.v1.Beskrivelse) defaultValue(fields()[0]);
        record.detaljer = fieldSetFlags()[1] ? this.detaljer : (java.util.Map<java.lang.CharSequence,java.lang.CharSequence>) defaultValue(fields()[1]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (java.util.Map.Entry<java.lang.CharSequence, java.lang.CharSequence> e0: this.detaljer.entrySet()) {
      actualSize0++;
      out.startItem();
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      this.beskrivelse = no.nav.paw.arbeidssokerregisteret.api.v1.Beskrivelse.values()[in.readEnum()];

      long size0 = in.readMapStart();
      java.util.Map<java.lang.CharSequence,java.lang.CharSequence> m0 = this.detaljer; // Need fresh name due to limitation of macro system
      if (m0 == null) {
