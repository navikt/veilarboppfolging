...
public class Jobbsituasjon extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private java.util.List<no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer> beskrivelser;
   ...
   */
  public Jobbsituasjon(java.util.List<no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer> beskrivelser) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: beskrivelser = (java.util.List<no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.List<no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer> getBeskrivelser() {
    return beskrivelser;
  }
   ...
   */
  public void setBeskrivelser(java.util.List<no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer> value) {
   ...
   */
  public static no.nav.paw.arbeidssokerregisteret.api.v1.Jobbsituasjon.Builder newBuilder() {
    return new no.nav.paw.arbeidssokerregisteret.api.v1.Jobbsituasjon.Builder();
  }
   ...
   * @return A new Jobbsituasjon RecordBuilder
   */
  public static no.nav.paw.arbeidssokerregisteret.api.v1.Jobbsituasjon.Builder newBuilder(no.nav.paw.arbeidssokerregisteret.api.v1.Jobbsituasjon.Builder other) {
    if (other == null) {
      return new no.nav.paw.arbeidssokerregisteret.api.v1.Jobbsituasjon.Builder();
    } else {
      return new no.nav.paw.arbeidssokerregisteret.api.v1.Jobbsituasjon.Builder(other);
    }
  }
   ...
   * @return A new Jobbsituasjon RecordBuilder
   */
  public static no.nav.paw.arbeidssokerregisteret.api.v1.Jobbsituasjon.Builder newBuilder(no.nav.paw.arbeidssokerregisteret.api.v1.Jobbsituasjon other) {
    if (other == null) {
      return new no.nav.paw.arbeidssokerregisteret.api.v1.Jobbsituasjon.Builder();
    } else {
      return new no.nav.paw.arbeidssokerregisteret.api.v1.Jobbsituasjon.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Jobbsituasjon>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(no.nav.paw.arbeidssokerregisteret.api.v1.Jobbsituasjon.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(no.nav.paw.arbeidssokerregisteret.api.v1.Jobbsituasjon other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.beskrivelser)) {
        this.beskrivelser = data().deepCopy(fields()[0].schema(), other.beskrivelser);
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.paw.arbeidssokerregisteret.api.v1.Jobbsituasjon.Builder setBeskrivelser(java.util.List<no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.paw.arbeidssokerregisteret.api.v1.Jobbsituasjon.Builder clearBeskrivelser() {
      beskrivelser = null;
    ...
    public Jobbsituasjon build() {
      try {
        ...
        record.beskrivelser = fieldSetFlags()[0] ? this.beskrivelser : (java.util.List<no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer>) defaultValue(fields()[0]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer e0: this.beskrivelser) {
      actualSize0++;
      out.startItem();
      e0.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer> a0 = this.beskrivelser;
      if (a0 == null) {
        a0 = new SpecificData.Array<no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer>((int)size0, SCHEMA$.getField("beskrivelser").schema());
        this.beskrivelser = a0;
      } else a0.clear();
      SpecificData.Array<no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new no.nav.paw.arbeidssokerregisteret.api.v1.BeskrivelseMedDetaljer();
          }
          e0.customDecode(in);
          a0.add(e0);
        }
