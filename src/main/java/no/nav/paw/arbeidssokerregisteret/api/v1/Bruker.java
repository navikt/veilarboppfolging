...
public class Bruker extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private no.nav.paw.arbeidssokerregisteret.api.v1.BrukerType type;
...
For veileder vil det være NAV identen til veilederen.
   */
  public Bruker(no.nav.paw.arbeidssokerregisteret.api.v1.BrukerType type, java.lang.CharSequence id) {
    this.type = type;
    this.id = id;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: type = (no.nav.paw.arbeidssokerregisteret.api.v1.BrukerType)value$; break;
   ...
   */
  public no.nav.paw.arbeidssokerregisteret.api.v1.BrukerType getType() {
    return type;
  }
   ...
   */
  public void setType(no.nav.paw.arbeidssokerregisteret.api.v1.BrukerType value) {
    this.type = value;
  }
...
For veileder vil det være NAV identen til veilederen.
   ...
   */
  public static no.nav.paw.arbeidssokerregisteret.api.v1.Bruker.Builder newBuilder() {
    return new no.nav.paw.arbeidssokerregisteret.api.v1.Bruker.Builder();
  }
   ...
   * @return A new Bruker RecordBuilder
   */
  public static no.nav.paw.arbeidssokerregisteret.api.v1.Bruker.Builder newBuilder(no.nav.paw.arbeidssokerregisteret.api.v1.Bruker.Builder other) {
    if (other == null) {
      return new no.nav.paw.arbeidssokerregisteret.api.v1.Bruker.Builder();
    } else {
      return new no.nav.paw.arbeidssokerregisteret.api.v1.Bruker.Builder(other);
    }
  }
   ...
   * @return A new Bruker RecordBuilder
   */
  public static no.nav.paw.arbeidssokerregisteret.api.v1.Bruker.Builder newBuilder(no.nav.paw.arbeidssokerregisteret.api.v1.Bruker other) {
    if (other == null) {
      return new no.nav.paw.arbeidssokerregisteret.api.v1.Bruker.Builder();
    } else {
      return new no.nav.paw.arbeidssokerregisteret.api.v1.Bruker.Builder(other);
...
For veileder vil det være NAV identen til veilederen. */
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(no.nav.paw.arbeidssokerregisteret.api.v1.Bruker.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(no.nav.paw.arbeidssokerregisteret.api.v1.Bruker other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.paw.arbeidssokerregisteret.api.v1.Bruker.Builder setType(no.nav.paw.arbeidssokerregisteret.api.v1.BrukerType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.paw.arbeidssokerregisteret.api.v1.Bruker.Builder clearType() {
      type = null;
...
For veileder vil det være NAV identen til veilederen.
      ...
      * @return This builder.
      */
    public no.nav.paw.arbeidssokerregisteret.api.v1.Bruker.Builder setId(java.lang.CharSequence value) {
...
For veileder vil det være NAV identen til veilederen.
      * @return This builder.
      */
    public no.nav.paw.arbeidssokerregisteret.api.v1.Bruker.Builder clearId() {
      id = null;
    ...
    public Bruker build() {
      try {
        ...
        record.type = fieldSetFlags()[0] ? this.type : (no.nav.paw.arbeidssokerregisteret.api.v1.BrukerType) defaultValue(fields()[0]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      this.type = no.nav.paw.arbeidssokerregisteret.api.v1.BrukerType.values()[in.readEnum()];
