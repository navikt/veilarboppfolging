...
public class Annet extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private no.nav.paw.arbeidssokerregisteret.api.v1.JaNeiVetIkke andreForholdHindrerArbeid;
   ...
   */
  public Annet(no.nav.paw.arbeidssokerregisteret.api.v1.JaNeiVetIkke andreForholdHindrerArbeid) {
  ...
  public java.lang.Object get(int field$) {
    switch (field$) {
    case 0: return andreForholdHindrerArbeid;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: andreForholdHindrerArbeid = (no.nav.paw.arbeidssokerregisteret.api.v1.JaNeiVetIkke)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public no.nav.paw.arbeidssokerregisteret.api.v1.JaNeiVetIkke getAndreForholdHindrerArbeid() {
   ...
   */
  public void setAndreForholdHindrerArbeid(no.nav.paw.arbeidssokerregisteret.api.v1.JaNeiVetIkke value) {
   ...
   */
  public static no.nav.paw.arbeidssokerregisteret.api.v2.Annet.Builder newBuilder() {
    return new no.nav.paw.arbeidssokerregisteret.api.v2.Annet.Builder();
  }
   ...
   * @return A new Annet RecordBuilder
   */
  public static no.nav.paw.arbeidssokerregisteret.api.v2.Annet.Builder newBuilder(no.nav.paw.arbeidssokerregisteret.api.v2.Annet.Builder other) {
    if (other == null) {
      return new no.nav.paw.arbeidssokerregisteret.api.v2.Annet.Builder();
    } else {
      return new no.nav.paw.arbeidssokerregisteret.api.v2.Annet.Builder(other);
    }
  }
   ...
   * @return A new Annet RecordBuilder
   */
  public static no.nav.paw.arbeidssokerregisteret.api.v2.Annet.Builder newBuilder(no.nav.paw.arbeidssokerregisteret.api.v2.Annet other) {
    if (other == null) {
      return new no.nav.paw.arbeidssokerregisteret.api.v2.Annet.Builder();
    } else {
      return new no.nav.paw.arbeidssokerregisteret.api.v2.Annet.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Annet>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(no.nav.paw.arbeidssokerregisteret.api.v2.Annet.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(no.nav.paw.arbeidssokerregisteret.api.v2.Annet other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.andreForholdHindrerArbeid)) {
        this.andreForholdHindrerArbeid = data().deepCopy(fields()[0].schema(), other.andreForholdHindrerArbeid);
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.paw.arbeidssokerregisteret.api.v2.Annet.Builder setAndreForholdHindrerArbeid(no.nav.paw.arbeidssokerregisteret.api.v1.JaNeiVetIkke value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.paw.arbeidssokerregisteret.api.v2.Annet.Builder clearAndreForholdHindrerArbeid() {
    ...
    public Annet build() {
      try {
        ...
        record.andreForholdHindrerArbeid = fieldSetFlags()[0] ? this.andreForholdHindrerArbeid : (no.nav.paw.arbeidssokerregisteret.api.v1.JaNeiVetIkke) defaultValue(fields()[0]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        this.andreForholdHindrerArbeid = no.nav.paw.arbeidssokerregisteret.api.v1.JaNeiVetIkke.values()[in.readEnum()];
      }
