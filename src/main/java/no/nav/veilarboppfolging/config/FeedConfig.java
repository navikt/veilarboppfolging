...
import no.nav.veilarboppfolging.feed.AvsluttetOppfolgingFeedProvider;
import no.nav.veilarboppfolging.feed.KvpFeedProvider;
import no.nav.veilarboppfolging.feed.OppfolgingFeedProvider;
