...
import no.nav.veilarboppfolging.domain.kafka.SisteVeilederTilordnetKafkaDTO;
...
public class DtoMappers {
    ...
    public static SisteVeilederTilordnetKafkaDTO tilSisteVeilederTilordnetKafkaDTO(Tilordning tilordning) {
        return new SisteVeilederTilordnetKafkaDTO(
