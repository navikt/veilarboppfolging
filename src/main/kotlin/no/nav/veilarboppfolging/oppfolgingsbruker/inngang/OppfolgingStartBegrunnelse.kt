...
enum class OppfolgingStartBegrunnelse {
    ...
    */
    ...
    BATCH_START_OPPFOLGING_MED_FORRIGE_AO_KONTOR;
    ...
    fun toStartetBegrunnelseDTO(): StartetBegrunnelseDTO {
        return when (this) {
            ...
            MANUELL_REGISTRERING_VEILEDER, BATCH_START_OPPFOLGING_MED_FORRIGE_AO_KONTOR -> StartetBegrunnelseDTO.MANUELL_REGISTRERING_VEILEDER
