...
public class KvpRessurs {
    ...
    @ApiOperation(
        ...
        notes="This API endpoint is only available for system users, set in the property 'kvp.api.brukertilgang'."
    )
    @ApiResponses({
    ...
    private boolean isRequestAuthorized() {
        ...
        String allowedUsersString = Utils.getSystemProperty("kvp.api.brukertilgang");
