...
public class ArenaServiceConfig {
    ...
    private static final String ARENASERVICE_OPPFOELGING_MOCK_KEY = "ytelseskontrakt.arenaservice.withmock";
    ...
    private CXFClient<OppfoelgingPortType> oppfoelgingPortType() {
        ...
        return new CXFClient<>(OppfoelgingPortType.class).address(url);
    }
