...
public class OppfoelgingV1Mock implements OppfoelgingPortType {
    ...
    @Override
    public HentOppfoelgingsstatusResponse hentOppfoelgingsstatus(HentOppfoelgingsstatusRequest hentOppfoelgingsstatusRequest) throws HentOppfoelgingsstatusPersonIkkeFunnet, HentOppfoelgingsstatusSikkerhetsbegrensning, HentOppfoelgingsstatusUgyldigInput {
